                ...
                <ul>
                    ...
                    Category</span
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<c:url value="/category/showcategories"/>" class="active">Category List</a>
                            </li>
                        </ul>
                    </li>
                    <li class="submenu">
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<c:url value="/location/showlocations"/>" class="active">Location List</a>
                            </li>
                        </ul>
                    </li>
                    <li class="submenu">
    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="<c:url value="/location/add_location"/> " class="btn btn-added">
                        <img

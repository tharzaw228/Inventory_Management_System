                ...
                <ul>
                    ...
                    Product</span
                        ...
                        <ul>
                            ...
                            <li><a href="<c:url value="/product/showproducts"/>" class="active">Product List</a></li>
                        </ul>
                    </li>
                    <li class="submenu">
                        <a href="javascript:void(0);"
    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="<c:url value="/product/add_product"/> " class="btn btn-added"
                    ><img
                        ...
                        <table class="table datanew">
                            ...
                            <c:forEach var="product" items="${productDtoList}">
                                <tr>
                                    ...
                                    <td>${product.categoryName} Fuck you </td>
                                    <td>

...
<div class="main-wrapper">
            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    Category</span
                        ...
                        <ul>
                            <li>
                                <a href="<c:url value="/category/add_category"/>">Add Category</a>
                            </li>
                    ...
                    Lot</span
                        >
                            ...
                            ></a>
                        <ul>
                            <li><a href="<c:url value="/lot/add_lot"/>" class="active">Add Lot </a></li>
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="card">
                <div class="card-body">
                    <form:form modelAttribute="lot" method="post" action="do_lot">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <form:select path="productId" class="select">
                                        <form:options items="${products}" itemValue="id"
                                                      itemLabel="productName"></form:options>
                                    </form:select>
